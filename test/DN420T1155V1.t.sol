...
contract DN420T1155V1Test is DSTestPlus, ERC1155TokenReceiver {
    DN420Mock token;
    ...
    function testMintToEOA() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 1);
    }
    ...
    function testMintToERC1155Recipient() public {
        ...
        assertEq(token.nftBalanceOf(address(to), 1337), 1);
    ...
    function testBatchMintToEOA() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 100);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1338), 200);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1339), 300);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1340), 400);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1341), 500);
    }
    ...
    function testBatchMintToERC1155Recipient() public {
        ...
        assertEq(token.nftBalanceOf(address(to), 1337), 100);
        assertEq(token.nftBalanceOf(address(to), 1338), 200);
        assertEq(token.nftBalanceOf(address(to), 1339), 300);
        assertEq(token.nftBalanceOf(address(to), 1340), 400);
        assertEq(token.nftBalanceOf(address(to), 1341), 500);
    }
    ...
    function testBurnNFT() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 30);
    }
    ...
    function testBatchBurn() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 50);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1338), 100);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1339), 150);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1340), 200);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1341), 250);
    }
    ...
    function testSafeTransferFromToEOA() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 70);
        assertEq(token.nftBalanceOf(from, 1337), 30);
    }
    ...
    function testSafeTransferFromToERC1155Recipient() public {
        ...
        assertEq(token.nftBalanceOf(address(to), 1337), 70);
        assertEq(token.nftBalanceOf(from, 1337), 30);
    }
    ...
    function testSafeTransferFromSelf() public {
        ...
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 70);
        assertEq(token.nftBalanceOf(address(this), 1337), 30);
    }
    ...
    function testSafeBatchTransferFromToEOA() public {
        ...
        assertEq(token.nftBalanceOf(from, 1337), 50);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1337), 50);

        assertEq(token.nftBalanceOf(from, 1338), 100);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1338), 100);

        assertEq(token.nftBalanceOf(from, 1339), 150);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1339), 150);

        assertEq(token.nftBalanceOf(from, 1340), 200);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1340), 200);

        assertEq(token.nftBalanceOf(from, 1341), 250);
        assertEq(token.nftBalanceOf(address(0xBEEF), 1341), 250);
    }
    ...
    function testSafeBatchTransferFromToERC1155Recipient() public {
        ...
        assertEq(token.nftBalanceOf(from, 1337), 50);
        assertEq(token.nftBalanceOf(address(to), 1337), 50);

        assertEq(token.nftBalanceOf(from, 1338), 100);
        assertEq(token.nftBalanceOf(address(to), 1338), 100);

        assertEq(token.nftBalanceOf(from, 1339), 150);
        assertEq(token.nftBalanceOf(address(to), 1339), 150);

        assertEq(token.nftBalanceOf(from, 1340), 200);
        assertEq(token.nftBalanceOf(address(to), 1340), 200);

        assertEq(token.nftBalanceOf(from, 1341), 250);
        assertEq(token.nftBalanceOf(address(to), 1341), 250);
    }
    ...
    function testMintToEOA(
        ...
        assertEq(token.nftBalanceOf(to, id), amount);
    }
    ...
    function testMintToERC1155Recipient(
        ...
        assertEq(token.nftBalanceOf(address(to), id), amount);
    ...
    function testBatchMintToEOA(
        ...
        for (uint256 i = 0; i < normalizedIds.length; i++) {
            ...
            assertEq(token.nftBalanceOf(to, id), userMintAmounts[to][id]);
        }
    }
    ...
    function testBatchMintToERC1155Recipient(
        ...
        for (uint256 i = 0; i < normalizedIds.length; i++) {
            ...
            assertEq(token.nftBalanceOf(address(to), id), userMintAmounts[address(to)][id]);
        }
    }
    ...
    function testBurn(
        ...
        assertEq(token.nftBalanceOf(address(to), id), mintAmount - burnAmount);
    }
    ...
    function testBatchBurn(
        ...
        for (uint256 i = 0; i < minLength; i++) {
            ...
            normalizedIds[i] = id;
            normalizedMintAmounts[i] = bound(mintAmounts[i], 0, remainingMintAmountForId / 10**25);
            normalizedBurnAmounts[i] = bound(burnAmounts[i], 0, normalizedMintAmounts[i] / 10**25);
        ...
        for (uint256 i = 0; i < normalizedIds.length; i++) {
            ...
            assertEq(token.nftBalanceOf(to, id), userMintAmounts[to][id] - userTransferOrBurnAmounts[to][id]);
        }
    }
    ...
    function testSafeTransferFromToEOA(
        ...
        if (to == from) {
            assertEq(token.nftBalanceOf(to, id), mintAmount);
        } else {
            assertEq(token.nftBalanceOf(to, id), transferAmount);
            assertEq(token.nftBalanceOf(from, id), mintAmount - transferAmount);
        }
    }
    ...
    function testSafeTransferFromToERC1155Recipient(
        ...
        assertEq(token.nftBalanceOf(address(to), id), transferAmount);
        assertEq(token.nftBalanceOf(from, id), mintAmount - transferAmount);
    }
    ...
    function testSafeTransferFromSelf(
        ...
        assertEq(token.nftBalanceOf(to, id), transferAmount);
        assertEq(token.nftBalanceOf(address(this), id), mintAmount - transferAmount);
    }
    ...
    function testSafeBatchTransferFromToEOA(
        ...
        for (uint256 i = 0; i < minLength; i++) {
            ...
            transferAmount = transferAmount/10**25;
        ...
        for (uint256 i = 0; i < normalizedIds.length; i++) {
            ...
            assertEq(token.nftBalanceOf(address(to), id), userTransferOrBurnAmounts[from][id]);
            assertEq(token.nftBalanceOf(from, id), userMintAmounts[from][id] - userTransferOrBurnAmounts[from][id]);
        }
    }
    ...
    function testSafeBatchTransferFromToERC1155Recipient(
        ...
        for (uint256 i = 0; i < normalizedIds.length; i++) {
            ...
            assertEq(token.nftBalanceOf(address(to), id), transferAmount);
            assertEq(token.nftBalanceOf(from, id), userMintAmounts[from][id] - transferAmount);
        }
    }
    ...
    function testBatchBalanceOf(
        ...
        for (uint256 i = 0; i < normalizedTos.length; i++) {
            assertEq(balances[i], token.nftBalanceOf(normalizedTos[i], normalizedIds[i]));
        }
    }
