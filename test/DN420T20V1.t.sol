...
contract DN420T20V1Test is DSTestPlus {
    DN420Mock token;
    ...
    function invariantMetadata() public {
        ...
        assertEq(token.baseURI(), "BASE_URL");
        assertEq(token.tokenUnit(), 10 ** 5);
    }
    ...
    function testMetadata(
        ...
        DN420Mock tkn = new DN420Mock(name, symbol, "", decimals, 10 ** 5);
